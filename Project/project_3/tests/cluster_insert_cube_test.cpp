...
class ClusterInsertCubeTest : public testing::Test
{
  protected:
    ClusterInsertCubeTest()
    {
    }

    ~ClusterInsertCubeTest() override
    {
    }
    ...
    void SetUp() override
    {
        ...
        cluster_insert = new ClusterInsert<double>(CUBE_ASSIGNMENT, mock_up_dataset->dataset, data_manager, mock_up_dataset->eu_metrics);
...
TEST_F(ClusterInsertCubeTest, AllPointsInserted)
{
